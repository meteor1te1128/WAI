export default async function handler(req, res) {
  ...
  const plans = {
    pro:  { name: 'WAI Pro',  description: '每天 30 次 · 6 种风格 · 无水印 · 2K 高清 · 30 天历史记录', amount: 10, interval: 'month' },
    max:  { name: 'WAI Max',  description: '无限次数 · 4K 超清 · 永久历史 · 商业授权 · 新风格优先体验',  amount: 30, interval: 'month' },
  };
